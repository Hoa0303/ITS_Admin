...
export const Receipt_API: string = base + "/receipt";
export const Statistic_API: string = base + "/statistic";
export const Review_API: string = base + "/review";
export const Log_API: string = base + "/log";