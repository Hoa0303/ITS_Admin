<template>
  <div>
    <h3 class="text-3xl font-semibold text-gray-700">Color Page</h3>
          ...
          <tbody>
            <tr v-for="(item, index) in colorData" :key="index"
              ...
              <td class="px-6 py-4 text-indigo-600 border-b cursor-pointer hover:text-indigo-900">
                <button @click="editColor(item)" class="mr-2">
        ...
        <form>
          ...
          <div class="px-5 pb-6 text-gray-700 bg-gray-200 border-b">
            ...
            <div class="relative mt-2 rounded-md shadow-sm">
              <input type="text" v-model="selectedColor.name"
